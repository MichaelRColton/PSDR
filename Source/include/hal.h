...
//    extern const Gpio_Pin OLED_NSS;
    ...
    extern const Gpio_Pin LCD_LED;
    extern const Gpio_Pin LCD_DC;
    extern const Gpio_Pin LCD_RESET;
    extern const Gpio_Pin SD_SCK;
    extern const Gpio_Pin SD_MISO;
    extern const Gpio_Pin SD_MOSI;
    extern const Gpio_Pin SD_NSS;
    extern const Gpio_Pin DDS_RESET;
    extern const Gpio_Pin DDS_SLEEP;
    extern const Gpio_Pin DDS_1_MOSI;
    extern const Gpio_Pin DDS_1_NSS;
    extern const Gpio_Pin DDS_1_SCK;
    extern const Gpio_Pin DDS_2_MOSI;
    extern const Gpio_Pin DDS_2_NSS;
    extern const Gpio_Pin DDS_2_SCK;
    extern const Gpio_Pin ENCODER_A;
    extern const Gpio_Pin ENCODER_B;
    extern const Gpio_Pin ENCODER_P;
    extern const Gpio_Pin ADC_0;
    extern const Gpio_Pin ADC_1;
    extern const Gpio_Pin ADC_2;
    extern const Gpio_Pin DAC_1;
    extern const Gpio_Pin DAC_2;
