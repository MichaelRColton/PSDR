...
// public:
  ...
  Adafruit_GFX_drawCircle(int16_t x0, int16_t y0, int16_t r, uint16_t color),
    ...
    Adafruit_GFX_fillCircleHelper(int16_t x0, int16_t y0, int16_t r, uint8_t cornername,
      ...
      int16_t radius, uint16_t color),
      Adafruit_GFX_drawColorBitmap(int16_t x, int16_t y, uint8_t *bitmap, int16_t w, int16_t h, uint16_t tintMask),
...
void Adafruit_GFX_drawColorBitmap(int16_t x, int16_t y, uint8_t *bitmap, int16_t w, int16_t h, uint16_t tintMask);
